...
public class UserGUI extends JFrame {
	...
	public UserGUI(Users u) {
		...
		btnNewButton.setBounds(42, 336, 89, 23);
		contentPane.add(btnNewButton);
		
		JLabel label = new JLabel(""+u.getCreationTime());
		label.setBounds(164, 340, 135, 14);
		contentPane.add(label);
		
		lblNewLabel_2 = new JLabel("" +u.getLastUpdatedTime());
		lblNewLabel_2.setBounds(164, 365, 135, 14);
